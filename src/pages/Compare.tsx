                ...
                {tool ? (
                  ...
                  >
                    ...
                    <div className="p-8 pb-0 text-center relative z-10 flex flex-col items-center">
                      <div className="w-14 h-14 mx-auto rounded-3xl mb-4 flex items-center justify-center bg-white border border-border relative group-hover:scale-110 transition-transform duration-500 overflow-hidden text-black">
                        {tool.icon_display.startsWith('http') || tool.icon_display.includes('.') ? (
                          <img src={tool.icon_display} alt={tool.name} className="w-full h-full object-contain" />
                        ) : (
              ...
              <div className="flex-1 overflow-y-auto p-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
                {isLoading ? (
                  ...
                  filteredToolsForSelection.map(tool => (
                    ...
                    >
                      <div className="w-12 h-12 rounded-xl bg-white border border-border flex items-center justify-center overflow-hidden shrink-0 group-hover:scale-110 transition-transform text-black">
                        {tool.icon_display.startsWith('http') || tool.icon_display.includes('.') ? (
                          <img src={tool.icon_display} alt={tool.name} className="w-full h-full object-contain" />
                        ) : (
